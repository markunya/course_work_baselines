...
# Download dataset (this will download a zip)
echo "Downloading VCTK-Demand dataset to: $OUT_DIR"
kaggle datasets download -d muhmagdy/valentini-noisy -p "$OUT_DIR" --unzip
